...
// Recovery captura panics em qualquer handler e responde com um erro 500
// padronizado, evitando que o processo derrube a conexão sem feedback ao
// cliente.
...
// respondError mapeia um erro de domínio (*apperror.AppError) para a
// resposta HTTP correspondente; qualquer outro erro vira 500 genérico.
